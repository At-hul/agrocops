...
import { _ as MessageCircle, h as Phone, l as Siren, y as MapPin } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/whatsapp-cta-D8aqhAXQ.js
...
function EmergencyCropHelpCta({ className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		className: cn("focus-ring fixed bottom-20 left-4 right-4 z-40 inline-flex min-h-12 items-center justify-center gap-2 rounded-md bg-accent px-4 py-3 text-sm font-bold text-accent-foreground shadow-soft transition-colors hover:bg-accent/90 md:bottom-4 md:left-auto md:right-6 md:w-auto", className),
		href: createWhatsAppUrl({
			context: "emergency",
...
//#endregion
export { siteConfig as a, createWhatsAppUrl as i, MobileQuickActions as n, WhatsappCta as r, EmergencyCropHelpCta as t };
