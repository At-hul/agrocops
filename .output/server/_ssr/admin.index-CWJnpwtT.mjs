...
import { S as Download, c as ShieldCheck, d as Save, f as RefreshCcw, h as MessageCircle, i as SquarePen, n as Trash2, p as Plus, v as LogOut } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.index-CWJnpwtT.js
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "font-bold",
							children: editing ? `Edit ${singularLabel(config.label)}` : `Add ${singularLabel(config.label)}`
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
